...
```sh
make build-installer IMG=<some-registry>/vernal-operator:tag
```
...
```sh
kubectl apply -f https://raw.githubusercontent.com/<org>/vernal-operator/<tag or branch>/dist/install.yaml
```
